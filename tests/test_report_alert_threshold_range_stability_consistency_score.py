...
from src.evaluation.report_alert_threshold_range_stability_consistency_score import (
    build_stability_consistency_score_summary,
    calculate_consistency_ratio,
    calculate_stability_consistency_percentage,
...
def test_stability_consistency_percentage():
    history = [
        {"alert_count": 1},
        {"alert_count": 2},
        {"alert_count": 3},
    ...
    assert calculate_stability_consistency_percentage(
        history,
        1,
        3,
    ) == pytest.approx(75.0)
...
def test_build_summary():
    ...
    summary = build_stability_consistency_score_summary(
        history,
        1,
        3,
    )
    ...
    assert summary == {
        ...
        "stability_consistency_score": pytest.approx(0.75),
        "stability_consistency_percentage": pytest.approx(75.0),
    }
...
def test_empty_history_summary():
    ...
    assert summary == {
        ...
        "stability_consistency_score": 0.0,
        "stability_consistency_percentage": 0.0,
    }
