    ...
    assert result["details"] == pytest.approx(
        [
            ...
            },
            {
                ...
                "consistency_change": -1.0,
            },
            {
                "snapshot_index": 2,
                "alert_count": 2,
                "quality_score": pytest.approx(2 / 3),
                "stability_score": pytest.approx(2 / 3),
                "consistency_score": 1.0,
                "quality_change": pytest.approx(1 / 6),
                "stability_change": pytest.approx(1 / 6),
                "consistency_change": 1.0,
            },
        ]
    )
