...
from src.evaluation.report_alert_threshold_range_stability_consistency_quality import (
    build_stability_consistency_quality_summary,
    calculate_consistency_ratio,
    calculate_stability_consistency_quality,
...
def test_stability_consistency_quality():
    history = [
        {"alert_count": 1},
        {"alert_count": 2},
        {"alert_count": 3},
    ...
    assert calculate_stability_consistency_quality(
        history,
        1,
        3,
    ) == pytest.approx(0.75)
...
def test_build_summary():
    ...
    summary = build_stability_consistency_quality_summary(
        history,
        1,
        3,
    )
    ...
    assert summary == {
        ...
        "stability_consistency_quality": pytest.approx(0.75),
        "stability_consistency_quality_percentage": pytest.approx(75.0),
    }
...
def test_empty_history_summary():
    ...
    assert summary == {
        ...
        "stability_consistency_quality": 0.0,
        "stability_consistency_quality_percentage": 0.0,
    }
