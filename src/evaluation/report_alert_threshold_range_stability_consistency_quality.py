...
def calculate_stability_consistency_score(
    ...
    """Calculate the combined stability-consistency score."""
...
def calculate_stability_consistency_quality(
    history: list[Mapping[str, Any]],
    lower_bound: int,
    upper_bound: int,
) -> float:
    """Return the combined score as a quality indicator."""
    return calculate_stability_consistency_score(
        history,
        lower_bound,
        upper_bound,
    )
...
def build_stability_consistency_quality_summary(
    history: list[Mapping[str, Any]],
    lower_bound: int,
    upper_bound: int,
) -> dict[str, Any]:
    """Build a summary of stability-consistency quality."""
    _validate_history(history)
    _validate_bounds(lower_bound, upper_bound)
    ...
    quality = calculate_stability_consistency_quality(
        history,
        lower_bound,
        upper_bound,
    )
    ...
    return {
        ...
        "stability_consistency_quality": quality,
        "stability_consistency_quality_percentage": quality * 100.0,
    }
