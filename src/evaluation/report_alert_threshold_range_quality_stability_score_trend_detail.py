...
def build_quality_stability_score_trend_detail(
    history: list[Mapping[str, Any]],
    lower_bound: int,
    upper_bound: int,
) -> dict[str, Any]:
    """Build detailed per-snapshot quality/stability trend information."""
    ...
    details = [
        {
            ...
            "quality": quality_series[index],
            "stability": stability_series[index],
            "score": score_series[index],
        }
        for index in range(trend["snapshot_count"])
    ]
