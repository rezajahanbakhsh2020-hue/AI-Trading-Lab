...
def calculate_stability_consistency_score(
    ...
    """Calculate the average stability-consistency score."""
...
def calculate_stability_consistency_percentage(
    history: list[Mapping[str, Any]],
    lower_bound: int,
    upper_bound: int,
) -> float:
    """Return the stability-consistency score as a percentage."""
    return (
...
def build_stability_consistency_score_summary(
    history: list[Mapping[str, Any]],
    lower_bound: int,
    upper_bound: int,
) -> dict[str, Any]:
    """Build a focused stability-consistency score summary."""
    _validate_history(history)
    _validate_bounds(lower_bound, upper_bound)
    ...
    score = calculate_stability_consistency_score(
        history,
        lower_bound,
        upper_bound,
    )

    percentage = calculate_stability_consistency_percentage(
        history,
        lower_bound,
        upper_bound,
    )
    ...
    return {
        ...
        "stability_consistency_score": score,
        "stability_consistency_percentage": percentage,
    }
