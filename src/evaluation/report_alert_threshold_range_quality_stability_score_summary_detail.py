"""Detailed summary analysis for threshold-range quality/stability scores."""
...
def calculate_quality_ratio(
    ...
    """Calculate the fraction of observations inside the range."""
...
def calculate_stability_ratio(
    ...
    """Calculate the fraction of transitions preserving range state."""
    _validate_history(history)
    _validate_bounds(lower_bound, upper_bound)
...
def calculate_quality_stability_score(
    ...
    """Calculate the average of quality and stability ratios."""
...
def classify_score(
    ...
    """Classify a score using stable and acceptable thresholds."""
...
def build_quality_stability_score_summary_detail(
    history: list[Mapping[str, object]],
    lower_bound: int,
    upper_bound: int,
    stable_threshold: float = 0.80,
    ...
    """Build a detailed summary with component scores and classification."""
    _validate_history(history)
    _validate_bounds(lower_bound, upper_bound)
    ...
    return {
        ...
        "quality_gap_to_stable": max(
            0.0,
            stable_threshold - quality_ratio,
        ),
        "stability_gap_to_stable": max(
            0.0,
            stable_threshold - stability_ratio,
        ),
        "score_gap_to_stable": max(
            0.0,
            stable_threshold - score,
        ),
    }
